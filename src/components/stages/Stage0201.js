...
export const Stage0201 = () => {
  return (
    <div>
      ...
      <table width="100%" border="0" cellSpacing="2" cellPadding="3" align="center" className="fontclass tabela2x5">
        <tbody>
        <tr>
          <td className="desno">8∙7 + 19=</td>
          <td className="lijevo"><Input answer="75"/></td>
        </tr>
        <tr>
          <td className="desno">9∙6 - 28=</td>
          <td className="lijevo"><Input answer="26"/></td>
        </tr>
        <tr>
